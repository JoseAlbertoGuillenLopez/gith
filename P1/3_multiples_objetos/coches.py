...
coche1.setPlazas(5)
coche1.num_serie =("daddjsi434")
#multiples objetos tener varios objetos de la misma clase y pueden tener mas o menos atributos acada objetos
